...
function setLink1() {
 var link1 = "../01-00.mp3";
 document.id3.apiclink.value = link1;
}

function setLink2() {
 var link1 = "../CD01/01-00.mp3";
 document.id3.apiclink.value = link1;
}
...
if(!empty($_POST["apiclink"]))
  $piclink = $_POST["apiclink"];
...
<form name="id3" method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>" style="margin-left:11%;" onsubmit="ladenein();">
 ...
 <fieldset style="width:900px;">
  ...
  <table border="0">
  <tr><td>
    artist: </td><td colspan="2"><input type="text" name="artist" style="width:344px;" value="<?php echo $artist ?>" />
  </td>
  <td>
    &nbsp; <a href="./mid3TagMp3Genre.php" target="genre">genre</a>:  </td><td colspan="2"><input type="text" name="genre" style="width:369px;" value="<?php echo $genre ?>" placeholder="101  (speech)" />
  </td>
  </tr>
  <tr><td>
    album:  </td><td colspan="2"><input type="text" name="album" style="width:344px;" value="<?php echo $album ?>" />
  </td>
  <td>
    &nbsp; year:  </td><td colspan="2"><input type="text" name="year" style="width:369px;" value="<?php echo $year ?>" />
  </td>
  </tr>
  <tr><td>
    title:  </td><td colspan="2"><input type="text" name="titel" style="width:344px;" value="<?php echo $titel ?>" placeholder="(%T :: track as prefix: 001-... | or in text: xxx 001 xxx)" />
  </td>
  <td>
    &nbsp; comm.:  </td><td colspan="2"><input type="text" name="comment" style="width:369px;" value="<?php echo $comment ?>" />
  </td>
  </tr>
  <tr><td>
    track:  </td><td colspan="2"><input type="text" name="track" style="width:344px;" value="<?php echo $track ?>" placeholder="001  (initial value)" />
  </td>
  <td>
    &nbsp; picture:  </td><td><input type="text" name="picture" style="width:316px;" value="<?php echo $picture ?>" placeholder="(first mp3 file only!)" />
  </td><td rowspan="2" style="vertical-align:top;">    
    <a href="javascript:setPic()">
    <img src="<?php if(strstr($picture,':')) { $array = explode(':',$picture); echo $array[0]; } else echo $picture; ?>" width="40" height="40" border="2" />
    </a>
    <!--<img src="<?php //echo $picture ?>" width="40" height="38" border="2" align="top" />-->
  </td>
  </tr>
  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>
    &nbsp; <a href="javascript:setLink1()">pic</a>-<a href="javascript:setLink2()">link</a>:  </td><td><input type="text" name="apiclink" style="width:316px;" value="<?php echo $piclink ?>" placeholder="(e.g. ../01-00.mp3)" />
  </td></tr>
  </table>
 </fieldset>
  <p>
